...
"""
xblock-react-5 documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-react-5',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/open-craft/xblock-react-5",
...
#
# html_title = 'xblock-react-5 v7.77.3'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'React XBlock Demo',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'react_xblock_2'),
                os.path.join(root_path, 'react_xblock_2/migrations')])
