var initReactXBlock8StudentView = (function () {
	...
	*/
	...
	var aa=requireReact(),m=requireObjectAssign(),r=requireScheduler();function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b);}
		...
		function df(a,b,c,d){var e=4<arguments.length&&void 0!==arguments[4]?arguments[4]:0,f=c;"selectionchange"===a&&9!==c.nodeType&&(f=c.ownerDocument);var g=$e(f),h=a+"__"+(b?"capture":"bubble");g.has(h)||(b&&(e|=4),af(f,a,e,b),g.add(h));}
	...
	*/
	...
	var _excluded$7 = ["as", "disabled", "onKeyDown"];
	...
	var SafeAnchor = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
	  ...
	  return /*#__PURE__*/React.createElement(Component, _extends$3({
	    ref: ref
	  }, props, {
	    onClick: handleClick,
	...
	var _excluded$6 = ["bsPrefix", "variant", "size", "active", "className", "block", "type", "as"];
	var defaultProps$2 = {
	  variant: 'primary',
	  active: false,
	  disabled: false
	...
	var Button$1 = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
	  ...
	  if (props.href) {
	    return /*#__PURE__*/React.createElement(SafeAnchor, _extends$3({}, props, {
	      as: as,
	      ref: ref,
	  ...
	  return /*#__PURE__*/React.createElement(Component, _extends$3({}, props, {
	    className: classes
	  }));
	});
	Button$1.displayName = 'Button';
	Button$1.defaultProps = defaultProps$2;

	var _excluded$5 = ["bsPrefix", "size", "toggle", "vertical", "className", "as"];
	var defaultProps$1 = {
	  vertical: false,
	  toggle: false,
	  role: 'group'
	};
	var ButtonGroup$1 = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
	  var bsPrefix = _ref.bsPrefix,
	      size = _ref.size,
	      toggle = _ref.toggle,
	      ...
	      rest = _objectWithoutPropertiesLoose$4(_ref, _excluded$5);

	  var prefix = useBootstrapPrefix(bsPrefix, 'btn-group');
	  var baseClass = prefix;
	  if (vertical) baseClass = prefix + "-vertical";
	  return /*#__PURE__*/React.createElement(Component, _extends$3({}, rest, {
	    ref: ref,
	    className: classNames(className, baseClass, size && prefix + "-" + size, toggle && prefix + "-toggle")
	  }));
	});
	ButtonGroup$1.displayName = 'ButtonGroup';
	ButtonGroup$1.defaultProps = defaultProps$1;

	var _excluded$4 = ["bsPrefix", "className"];
	var defaultProps = {
	  role: 'toolbar'
	};
	var ButtonToolbar$1 = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
	  var bsPrefix = _ref.bsPrefix,
	      className = _ref.className,
	...
	ButtonToolbar$1.displayName = 'ButtonToolbar';
	ButtonToolbar$1.defaultProps = defaultProps;
	...
	var DeprTypes = /*#__PURE__*/function (DeprTypes) {
	...
	function withDeprecatedProps(WrappedComponent, componentName, deprecatedProps) {
	  var WithDeprecatedProps = /*#__PURE__*/function (_React$Component) {
	    _inherits$1(WithDeprecatedProps, _React$Component);
	    var _super = _createSuper$1(WithDeprecatedProps);
	    // eslint-disable-next-line react/static-property-placement

	    function WithDeprecatedProps(props) {
	      var _this;
	      _classCallCheck$1(this, WithDeprecatedProps);
	      _this = _super.call(this, props);
	      _this.transformProps = _this.transformProps.bind(_assertThisInitialized$1(_this));
	      return _this;
	    }
	    _createClass$1(WithDeprecatedProps, [{
	      key: "warn",
	      ...
	      value: function render() {
	        var _Object$keys$reduce = Object.keys(this.props).reduce(this.transformProps, {}),
	          ...
	          transformedProps = _objectWithoutProperties$3(_Object$keys$reduce, _excluded$3);
	  ...
	  _defineProperty$3(WithDeprecatedProps, "displayName", "withDeprecatedProps(".concat(componentName, ")"));
	  return WithDeprecatedProps;
	}

	function _typeof$2(o) { "@babel/helpers - typeof"; return _typeof$2 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof$2(o); }
	var _excluded$2 = ["buttonType", "className", "children", "isClose", "type", "inputRef"];
	    ...
	    */
	    ...
	    value: function render() {
	      var _this$props = this.props,
	        ...
	        var other = _objectWithoutProperties$2(_this$props, _excluded$2);
	      return /*#__PURE__*/React.createElement("button", _extends$2({}, other, {
	        className: classNames(['btn', className], _defineProperty$2({}, "btn-".concat(buttonType), buttonType !== undefined), {
	          close: isClose
	        }),
	        onBlur: this.onBlur,
	...
	var ButtonDeprecated = withDeprecatedProps(DeprecatedButton, 'Button', {
	  label: {
	...
	var _excluded$1 = ["src", "id", "className", "hidden", "screenReaderText", "svgAttrs", "size"];
	...
	function Icon(_ref) {
	  var Component = _ref.src,
	    ...
	    size = _ref.size,
	    attrs = _objectWithoutProperties$1(_ref, _excluded$1);
	  if (Component) {
	    ...
	    var mergedSvgProps = _objectSpread$1({}, svgAttrs);
	    if (!hasAriaLabel) {
	      mergedSvgProps['aria-label'] = undefined;
	      mergedSvgProps['aria-hidden'] = true;
	    }
	    return /*#__PURE__*/React.createElement("span", _extends$1({
	      className: classNames('pgn__icon', _defineProperty$1({}, "pgn__icon__".concat(size), !!size), className),
	      id: id
	    }, attrs), /*#__PURE__*/React.createElement(Component, _extends$1({
	      role: "img",
	      focusable: false
	...
	var Icon$1 = withDeprecatedProps(Icon, 'Icon', {
	  className: {
	    deprType: DeprTypes.FORMAT,
	    expect: function expect(value) {
	      return typeof value === 'string';
	...
	var Button = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
	  ...
	  return /*#__PURE__*/React.createElement(Button$1, _extends({
	    ...
	    ref: ref
	  }), iconBefore && /*#__PURE__*/React.createElement(Icon$1, {
	    className: "btn-icon-before",
	    size: size,
	    src: iconBefore
	  }), children, iconAfter && /*#__PURE__*/React.createElement(Icon$1, {
	...
	var ButtonGroup = /*#__PURE__*/React.forwardRef(function (_ref2, ref) {
	  ...
	  return /*#__PURE__*/React.createElement(ButtonGroup$1, _extends({
	    size: size
	  }, props, {
	    ref: ref
	  }));
	...
	var ButtonToolbar = /*#__PURE__*/React.forwardRef(function (props, ref) {
	  return /*#__PURE__*/React.createElement(ButtonToolbar$1, _extends({}, props, {
	    ref: ref
	  }));
	});
